      ...
      <div className="command-form">
        <form onSubmit={(e) => { e.preventDefault(); }}>
          ...
          <div className="target">
            ...
            <FlatButton data-tip="<p>Select target</p>" className={classNames("icon", "si-select", {"active": this.props.isSelecting})} onClick={select} />
            <FlatButton data-tip="<p>Find target</p>" className="icon si-search" onClick={() => {find(this.props.command.target);}} />
          </div>
          <Input
            id="value"
            name="value"
