  ...
  describe("Preprocess", () => {
    ...
    describe("Syntax Invalidation", () => {
      test("if", () => {
        ...
        expect(function() { validateControlFlowSyntax(input); }).toThrow("Incomplete block at if");
      });
      test("if, if, end", () => {
        let input = [
          createCommand(ControlFlowCommandNames.if),
      ...
      test("if, else, elseIf, end", () => {
        ...
        expect(function() { validateControlFlowSyntax(input); }).toThrow("Incorrect command order of else if / else");
      });
      test("if, else, else, end", () => {
        ...
        expect(function() { validateControlFlowSyntax(input); }).toThrow("Too many else commands used");
      });
      test("else", () => {
      ...
      test("while", () => {
        ...
        expect(function() { validateControlFlowSyntax(input); }).toThrow("Incomplete block at while");
      });
      test("if, while", () => {
        let input = [
          createCommand(ControlFlowCommandNames.if),
      ...
      test("times", () => {
        ...
        expect(function() { validateControlFlowSyntax(input); }).toThrow("Incomplete block at times");
      });
      test("repeatIf", () => {
        let input = [createCommand(ControlFlowCommandNames.repeatIf)];
        expect(function() { validateControlFlowSyntax(input); }).toThrow("A repeat if used without a do block");
      });
      test("do", () => {
        let input = [createCommand(ControlFlowCommandNames.do)];
        expect(function() { validateControlFlowSyntax(input); }).toThrow("Incomplete block at do");
      });
      test("end", () => {
        let input = [createCommand(ControlFlowCommandNames.end)];
        expect(function() { validateControlFlowSyntax(input); }).toThrow("Use of end without an opening keyword");
      });
    });
  });
});
