...
export default class DialogContainer extends React.Component {
  ...
  render() {
    return (
      <div className={classNames("dialog", `dialog--${this.props.type}`, this.props.className)}>
        <div className="dialog__header">
          <div className="dialog__cover-image">
            {this.props.renderImage ? this.props.renderImage() : <img height="30" src={images[this.props.type]} />}
          </div>
