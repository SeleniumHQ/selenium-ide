...
export class WindowSession {
  ...
  dedicateGeneralUseSession(identifier) {
    ...
    this.openedTabCount[identifier] = this.openedTabCount[
      this.generalUseIdentifier
    ]
    delete this.openedTabCount[this.generalUseIdentifier]
    this.currentUsedTabId[identifier] = this.currentUsedTabId[
      this.generalUseIdentifier
    ]
    delete this.currentUsedTabId[this.generalUseIdentifier]
    this.currentUsedWindowId[identifier] = this.currentUsedWindowId[
      this.generalUseIdentifier
    ]
    delete this.currentUsedWindowId[this.generalUseIdentifier]
    this.currentUsedFrameLocation[identifier] = this.currentUsedFrameLocation[
      this.generalUseIdentifier
    ]
