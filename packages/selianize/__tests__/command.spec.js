...
describe('command code emitter', () => {
  ...
  it('should emit `click` command', () => {
    ...
    return expect(CommandEmitter.emit(command)).resolves.toBe(
      'await driver.wait(until.elementLocated(By.linkText(`button`)), configuration.timeout);await driver.findElement(By.linkText(`button`)).then(element => {element.click();});'
    )
  })
  ...
  it('should emit `double click` command', () => {
    ...
    return expect(CommandEmitter.emit(command)).resolves.toBe(
      'await driver.wait(until.elementLocated(By.linkText(`button`)), configuration.timeout);await driver.findElement(By.linkText(`button`)).then(element => {driver.actions().doubleClick(element).perform();});'
    )
  })
  ...
  it('should emit `drag and drop to object` command', () => {
    ...
    return expect(CommandEmitter.emit(command)).resolves.toBe(
      'await driver.wait(until.elementLocated(By.linkText(`dragged`)), configuration.timeout);await driver.wait(until.elementLocated(By.linkText(`dropzone`)), configuration.timeout);await driver.findElement(By.linkText(`dragged`)).then(dragged => {driver.findElement(By.linkText(`dropzone`)).then(dropzone => {driver.actions().dragAndDrop(dragged, dropzone).perform();});});'
    )
  })
  it('should emit `type` command', () => {
    ...
    return expect(CommandEmitter.emit(command)).resolves.toBe(
      `await driver.wait(until.elementLocated(By.id(\`input\`)), configuration.timeout);await driver.findElement(By.id(\`input\`)).then(element => {element.clear().then(() => {element.sendKeys(\`${
        command.value
      }\`);});});`
    )
  })
  it('should emit `send keys` command', () => {
    ...
    return expect(CommandEmitter.emit(command)).resolves.toBe(
      `await driver.wait(until.elementLocated(By.id(\`input\`)), configuration.timeout);await driver.findElement(By.id(\`input\`)).then(element => {element.sendKeys(\`${
        command.value
      }\`);});`
    )
  })
  ...
  it('should emit `check` command', () => {
    ...
    return expect(CommandEmitter.emit(command)).resolves.toBe(
      'await driver.wait(until.elementLocated(By.id(`f`)), configuration.timeout);await driver.findElement(By.id(`f`)).then(element => { element.isSelected().then(selected => {if(!selected) { element.click();}}); });'
    )
  })
  ...
  it('should emit `verify not text` command', () => {
    ...
    return expect(CommandEmitter.emit(command)).resolves.toBe(
      `await driver.wait(until.elementLocated(By.id(\`test\`)), configuration.timeout);await driver.findElement(By.id(\`test\`)).then(element => {element.getText().then(text => {expect(text).not.toBe(\`${
        command.value
      }\`)});});`
    )
  })
  it('should emit `verify title` command', () => {
    ...
    return expect(CommandEmitter.emit(command)).resolves.toBe(
      `await driver.getTitle().then(title => {expect(title).toBe(\`${
        command.target
      }\`);});`
    )
  })
  ...
  it('should emit `store text` command', () => {
    ...
    return expect(CommandEmitter.emit(command)).resolves.toBe(
      `await driver.wait(until.elementLocated(By.id(\`someElement\`)), configuration.timeout);await driver.findElement(By.id(\`someElement\`)).then(element => {element.getText().then(text => {vars["${
        command.value
      }"] = text;});});`
    )
  })
  it('should emit `store value` command', () => {
    ...
    return expect(CommandEmitter.emit(command)).resolves.toBe(
      `await driver.wait(until.elementLocated(By.id(\`someElement\`)), configuration.timeout);await driver.findElement(By.id(\`someElement\`)).then(element => {element.getAttribute("value").then(value => {vars["${
        command.value
      }"] = value;});});`
    )
  })
  it('should emit `store title` command', () => {
    ...
    return expect(CommandEmitter.emit(command)).resolves.toBe(
      `await driver.getTitle().then(title => {vars["${
        command.value
      }"] = title;});`
    )
  })
  it('should emit `store xpath count` command', () => {
    ...
    return expect(CommandEmitter.emit(command)).resolves.toBe(
      `await driver.wait(until.elementsLocated(By.xpath(\`button\`)), configuration.timeout);await driver.findElements(By.xpath(\`button\`)).then(elements => {vars["${
        command.value
      }"] = elements.length;});`
    )
  })
  it('should emit `store attribute` command', () => {
    ...
    return expect(CommandEmitter.emit(command)).resolves.toBe(
      `await driver.wait(until.elementLocated(By.xpath(\`button[3]\`)), configuration.timeout);await driver.findElement(By.xpath(\`button[3]\`)).then(element => element.getAttribute("id").then(attribute => {vars["${
        command.value
      }"] = attribute;}));`
    )
  })
  it('should emit `select` command', () => {
    ...
    return expect(CommandEmitter.emit(command)).resolves.toBe(
      "await driver.wait(until.elementLocated(By.css(`select`)), configuration.timeout);await driver.findElement(By.css(`select`)).then(element => {element.findElement(By.xpath(`//option[. = 'A label']`)).then(option => {option.click();});});"
    )
  })
  ...
  it('should emit `select frame` to select a frame by locator', () => {
    ...
    return expect(CommandEmitter.emit(command)).resolves.toBe(
      'await driver.findElement(By.id(`frame`)).then(frame => {driver.switchTo().frame(frame);});'
    )
  })
  ...
  it('should emit `mouse down` event', () => {
    ...
    return expect(CommandEmitter.emit(command)).resolves.toBe(
      'await driver.wait(until.elementLocated(By.id(`button`)), configuration.timeout);await driver.findElement(By.id(`button`)).then(element => {driver.actions().mouseDown(element).perform();});'
    )
  })
  ...
  it('should emit `mouse up` event', () => {
    ...
    return expect(CommandEmitter.emit(command)).resolves.toBe(
      'await driver.wait(until.elementLocated(By.id(`button`)), configuration.timeout);await driver.findElement(By.id(`button`)).then(element => {driver.actions().mouseUp(element).perform();});'
    )
  })
  ...
  it('should emit `mouse move` event', () => {
    ...
    return expect(CommandEmitter.emit(command)).resolves.toBe(
      'await driver.wait(until.elementLocated(By.id(`button`)), configuration.timeout);await driver.findElement(By.id(`button`)).then(element => {driver.actions().mouseMove(element).perform();});'
    )
  })
  ...
  it('should emit `mouse out` event', () => {
    ...
    return expect(CommandEmitter.emit(command)).resolves.toBe(
      'await driver.wait(until.elementLocated(By.id(`button`)), configuration.timeout);await driver.findElement(By.id(`button`)).then(element => {driver.actions().mouseMove(element, {x: -1, y: -1}).perform();});'
    )
  })
  it('should emit `assert alert` command', () => {
    ...
    return expect(CommandEmitter.emit(command)).resolves.toBe(
      `await driver.switchTo().alert().then(alert => {alert.getText().then(text => {expect(text).toBe(\`${
        command.target
      }\`);alert.accept();});});`
    )
  })
  ...
  it('should emit `choose ok on visible confirmation` command', () => {
    ...
    return expect(CommandEmitter.emit(command)).resolves.toBe(
      'await driver.switchTo().alert().then(alert => {alert.accept();});'
    )
  })
  ...
  it('should emit `answer on visible prompt` command', () => {
    ...
    return expect(CommandEmitter.emit(command)).resolves.toBe(
      `await driver.switchTo().alert().then(alert => {alert.sendKeys(\`${
        command.target
      }\`).then(() => {alert.accept();});});`
    )
  })
  ...
  it('should emit `edit content` command', () => {
    ...
    return expect(CommandEmitter.emit(command)).resolves.toBe(
      `await driver.wait(until.elementLocated(By.id(\`contentEditable\`)), configuration.timeout);await driver.findElement(By.id(\`contentEditable\`)).then(element => {driver.executeScript(\`if(arguments[0].contentEditable === 'true') {arguments[0].innerHTML = '${
        command.value
      }'}\`, element);});`
    )
  })
  it('should emit `submit` command', () => {
    ...
    return expect(CommandEmitter.emit(command)).resolves.toBe(
      'await driver.wait(until.elementLocated(By.id(`form`)), configuration.timeout);await driver.findElement(By.id(`form`)).then(element => {element.submit();});'
    )
  })
