...
import downloadDriver from '../download-driver'
  ...
  it('should fail to download a non-existent driver', async () => {
    ...
    try {
      ...
      expect(err.message).toBe(
        'Failed to get chromedriver version for chrome version 6.0.9 from url https://chromedriver.storage.googleapis.com/LATEST_RELEASE_6'
      )
    }
  })
})
